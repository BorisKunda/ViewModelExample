package com.happytrees.viewmodelexample;
...
public class MainActivity extends AppCompatActivity {
   ...
   // int scoreTeamB = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(ScoreViewModel.class);//create association between this activity and ViewModel.
